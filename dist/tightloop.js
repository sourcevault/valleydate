...
(function(){
  var reg, com, already_created, pkgname, sig, z, l, R, j, main, sanatize, x$, apply, y$, z$, blunder, difKey, difTop, map, upon, settle, slice$ = [].slice, arrayFrom$ = Array.from || function(x){return slice$.call(x);};
