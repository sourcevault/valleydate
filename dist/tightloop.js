...
(function(){
  var reg, com, already_created, pkgname, sig, z, l, R, j, main, sanatize, blunder, x$, apply, y$, z$, difKey, difTop, map, upon, settle, slice$ = [].slice, arrayFrom$ = Array.from || function(x){return slice$.call(x);};
  ...
  settle = function(fun, put, dtype, args){
