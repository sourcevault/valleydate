...
(function(){
  var reg, com, print, l, z, R, j, prettyError, hop, flat, pad, alphaSort, sig, pkgname, x$, c, help, pe, show_stack, lit, show_chain, show_name, y$, on_dtype, sort, includes, same, myflat, split, find_len, slice$ = [].slice, arrayFrom$ = Array.from || function(x){return slice$.call(x);};
  reg = require("./registry");
  com = reg.com, print = reg.print;
  l = com.l, z = com.z, R = com.R, j = com.j, prettyError = com.prettyError, hop = com.hop, flat = com.flat;
