...
(function(){
  var reg, com, print, tightloop, sig, cache, z, l, R, hop, j, uic, deep_freeze, loopError, assort, cato, x$, wrap, y$, gaurd, z$, define, z1$, validate, props, initState, z2$, proto, key, val, handleError, custom, pkg, slice$ = [].slice, arrayFrom$ = Array.from || function(x){return slice$.call(x);};
