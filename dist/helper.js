...
(function(){
  var reg, com, pkg, loopError, print, already_created, z, l, R, j, hop, be, internal, slice$ = [].slice, arrayFrom$ = Array.from || function(x){return slice$.call(x);};
  ...
  internal.boolnum = function(val){
    var ref$;
    if ((ref$ = R.type(val)) === 'Boolean' || ref$ === 'Number') {
      return [true];
    } else {
