...
(function(){
  var reg, com, pkg, loopError, print, already_created, internal, z, l, R, j, hop, deepFreeze, uic, custom, dressing, define, be, props, i$, len$, ref$, name, type, F, G, H, showAttr, reqError, integer, boolnum, maybe_boolnum, maybe, undefnull, list, slice$ = [].slice, arrayFrom$ = Array.from || function(x){return slice$.call(x);};
