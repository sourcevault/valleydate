...
(function(){
  var reg, com, pkg, loopError, print, internal, cache, z, l, R, j, hop, deepFreeze, uic, custom, define, be, props, nonmap, base, not_base, undefnull, i$, len$, ref$, name, type, A, B, reqError, integer, boolnum, maybe_boolnum, maybe, list, slice$ = [].slice, arrayFrom$ = Array.from || function(x){return slice$.call(x);};
