...
(function(){
  var ref$, z, l, SI, R, guard, noops, moduleName, unfinished, sim, utilInspectCustom, registry, booly, local, checkF, createError, x$, onn, create_atomic, i$, len$, val, key;
  ref$ = require("./common"), z = ref$.z, l = ref$.l, SI = ref$.SI, R = ref$.R, guard = ref$.guard, noops = ref$.noops, moduleName = ref$.moduleName;
  ...
  onn.entry = guard(function(data, args, UFO){
